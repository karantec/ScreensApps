import { Check, MapPin, User, Phone, Minus, Plus, X } from "lucide-react";
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-emerald-500 text-white py-3 px-4">
        <div className="flex items-center justify-center">
          <div className="w-4 h-4 bg-white bg-opacity-30 rounded-full flex items-center justify-center mr-2">
      ...
      <div className="w-full  sm:max-w-sm sm:mx-auto lg:max-w-2xl bg-white min-h-screen">
        ...
        <div className="px-4 space-y-4">
          ...
          <div className="bg-emerald-50 rounded-lg overflow-hidden">
            ...
            <div className="p-4">
              <div className="sm:grid sm:grid-cols-1 lg:grid-cols-2 gap-4 space-y-4 sm:space-y-4 lg:space-y-0">
                {/* Check-In Time */}
            ...
            <div className="bg-emerald-100 px-4 py-2.5 flex items-center justify-between">
              ...
              <div className="flex items-center space-x-2">
                ...
                <div className="flex items-center bg-white rounded border border-gray-200 px-1">
                  ...
                  <span className="mx-2 text-sm font-medium min-w-[16px] text-center">
                    {quantity}
                  </span>
                  <button
                    onClick={increaseQuantity}
                    className="w-6 h-6 bg-emerald-500 text-white flex items-center justify-center rounded hover:bg-emerald-600"
                  >
